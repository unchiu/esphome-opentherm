...
CONFIG_SCHEMA = cv.All(
    cv.Schema({
        ...
        cv.Optional("opentherm_version_controller", 5): cv.float_,
        cv.Optional("controller_id", 5): cv.positive_int,
        cv.Optional("master_id", 5): cv.positive_int,
        ...
        cv.Optional("opentherm_version", 4): cv.int_,
